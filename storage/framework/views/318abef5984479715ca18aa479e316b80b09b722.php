...
<?php echo Form::model($paidvouchers ,array('route' =>  'update.paid.voucher', 'id' => 'form-with-validation', 'class' => 'form-horizontal','autocomplete' => 'off' , "enctype" => 'multipart/form-data')); ?>


    <input type="hidden" name="selectedVoucherId" value="<?php echo e($paidvouchers->id); ?>">
        ...
        <div class="col-sm-10">
            <div class="form-check">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="voucherType" <?php echo e(($paidvouchers->fileName != null && $paidvouchers->fileName != '') ? 'checked' : ''); ?> value="uploadVoucher">Upload voucher
                </label>
            </div>
            <div class="form-check">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="voucherType" <?php echo e(($paidvouchers->fileName == null && $paidvouchers->fileName == '') ? 'checked' : ''); ?> value="preTemp">Pre Template
                </label>
            </div>
        </div>
    </div>
    <div class="voucherslistimages <?php echo e(($paidvouchers->fileName == null && $paidvouchers->fileName == '') ? 'show' : 'hide'); ?>" >
        <div class="form-group " >
            <?php echo Form::label('voucher_template', 'Voucher Template*', array('class'=>'col-sm-2 control-label')); ?>
    ...
    <div class="browseImage <?php echo e(($paidvouchers->fileName != null && $paidvouchers->fileName != '') ? 'show' : 'hide'); ?>" >
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="custom-file">
                    ...
                    <br>
                    <img src="<?php echo e(asset('voucher/images/'.$paidvouchers->fileName)); ?>" style="width: 200px">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-10">
            <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="voucher_of">
                <?php $__currentLoopData = $vouchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if( $v->Offer != null ): ?>
                        <option <?php echo e(($paidvouchers->voucher_of == $v->offer->id)? 'selected' : ''); ?> data-subtext="<?php echo e(($v->Offer != null) ? $v->Offer->title : ''); ?> (<?php echo e((strlen($v->title) > 50 ) ? substr($v->title, 0 , 50).' .....' : $v->title); ?>)" value="<?php echo e($v->Offer->id); ?>"><?php echo e($v->voucher_unique_id); ?></option>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sboy8c4wy24p/public_html/thediscountindia.com/admin/resources/views/admin/paidVouchers/edit.blade.php ENDPATH**/ ?>