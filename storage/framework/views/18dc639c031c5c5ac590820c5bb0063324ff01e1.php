...
<?php echo Form::open(array('files' => true, 'route' => config('coreadmin.route').'.topslider.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sboy8c4wy24p/public_html/thediscountindia.com/admin/resources/views/admin/topslider/create.blade.php ENDPATH**/ ?>