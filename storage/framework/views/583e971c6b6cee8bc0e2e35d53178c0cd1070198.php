...
<?php echo Form::open(array('route' => 'craete.voucher', 'id' => 'form-with-validation', 'class' => 'form-horizontal','autocomplete' => 'off')); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <label><input checked="checked" name="plan_id[]" type="checkbox" value="<?php echo e($v->id); ?>"> <?php echo e($v->title); ?> </label>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<input type="hidden" name="voucher_of" value="<?php echo e(end($explode)); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sboy8c4wy24p/public_html/thediscountindia.com/admin/resources/views/admin/vouchers/create.blade.php ENDPATH**/ ?>