                    ...
                    <tbody>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="<?php echo e(($user->status == 0 && $user->role_id != 3 && $user->id != 1)? 'red' : 'tr'); ?>">
                                ...
                                <td class="hide"><?php echo e(date_format(date_create($user->created_at),"Y-m-d")); ?></td>
                                <td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sboy8c4wy24p/public_html/thediscountindia.com/admin/resources/views/admin/users/index.blade.php ENDPATH**/ ?>