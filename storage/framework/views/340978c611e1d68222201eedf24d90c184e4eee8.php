...
<head>
    ...
    <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all"
          ...
          type="text/css"/>
    <link rel="stylesheet"
          href="<?php echo e(url('coreadmin/css')); ?>/font-awesome.min.css"/>
    <link rel="stylesheet"
          href="<?php echo e(url('coreadmin/css')); ?>/bootstrap.min.css"/>
    <link rel="stylesheet"
          href="<?php echo e(url('coreadmin/css')); ?>/components.css"/>
    <link rel="stylesheet"
          href="<?php echo e(url('coreadmin/css')); ?>/coreadmin-layout.css"/>
    <link rel="stylesheet"
          href="<?php echo e(url('coreadmin/css')); ?>/coreadmin-theme-default.css"/>
    <link rel="stylesheet"
...
<body class="page-header-fixed"><?php /**PATH /home/sboy8c4wy24p/public_html/thediscountindia.com/admin/resources/views/admin/partials/header.blade.php ENDPATH**/ ?>