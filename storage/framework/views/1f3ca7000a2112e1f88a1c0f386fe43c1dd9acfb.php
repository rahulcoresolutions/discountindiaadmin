...
<?php echo Form::open(array('files' => true, 'route' => config('coreadmin.route').'.delivery.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <?php echo Form::text('valid', old('valid'), array('class'=>'form-control datepicker')); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sboy8c4wy24p/public_html/thediscountindia.com/admin/resources/views/admin/delivery/create.blade.php ENDPATH**/ ?>