...
<a href="<?php echo e(route('hot.deals.category')); ?>" class="btn btn-primary">Hot Deals Category</a>
<?php if($hotdeals->count()): ?>
                ...
                <tbody id="sortable">
                    <?php $__currentLoopData = $hotdeals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-id="<?php echo e($row->id); ?>" data-order="<?php echo e($row->order); ?>">
                            ...
                            <td><?php echo e($row->voucher_id); ?></td>
                            <td><?php echo e($row->banner); ?></td>
                            <td>
                                <?php echo link_to_route(config('coreadmin.route').'.hotdeals.edit', trans('coreadmin::templates.templates-view_index-edit'), array($row->id), array('class' => 'btn btn-xs btn-info')); ?>

                                <?php echo Form::open(array('style' => 'display: inline-block;', 'method' => 'DELETE', 'onsubmit' => "return confirm('".trans("coreadmin::templates.templates-view_index-are_you_sure")."');",  'route' => array(config('coreadmin.route').'.hotdeals.destroy', $row->id))); ?>
        ...
        $(document).ready(function () {
            ...
            $( "#sortable" ).sortable({
                update: function( event, ui ) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('hot.product.sort')); ?>",
                        type:"POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sboy8c4wy24p/public_html/thediscountindia.com/admin/resources/views/admin/hotdeals/index.blade.php ENDPATH**/ ?>